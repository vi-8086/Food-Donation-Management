...
$fitemarray=implode(",",$fitem);
    $query=mysqli_query($con, "insert into tblfood(DonorID,foodId, CityName, FoodItems, Description,
     PickupDate,PickupAddress,ContactPerson,CPMobNumber,Status) 
     value('$donorid','$fid','$cityname','$fitemarray','$description','$pdate',
     '$padd','$contactperson','$cpmobnum','$status')");
...
<!DOCTYPE html>
<head>
<title>Donor|Add Food Details</title>
...
<td><button type="button" name="add" id="add" class="btn btn-success">Add More</button></td>
              ...
              <option value="<?php echo $row['City'];?>"><?php echo $row['City'];?></option>
                  <?php } ?> 
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Contact Mobile No.</label>
                        <div class="col-sm-6">
