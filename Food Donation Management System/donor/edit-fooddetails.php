...
$fitemarray=implode(",",$fitem);
    $query=mysqli_query($con, "update tblfood set FoodItems='$fitemarray', CityName='$cityname', Description='$description', PickupDate='$pdate', PickupAddress='$padd',ContactPerson='$contactperson',CPMobNumber='$cpmobnum' where ID='$eid'");
    if ($query) {
