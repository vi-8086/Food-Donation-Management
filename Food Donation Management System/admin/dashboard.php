...
?>
					<div class="col-md-8 market-update-left">
					<h4><a href="manage-city.php" style="color: white">Cities</a></h4>
...
?>
					<div class="col-md-8 market-update-left">
					<h4><a href="manage-donor-details.php" style="color: white">Registered Donors</a></h4>
...
?>
					<div class="col-md-8 market-update-left">
					<h4><a href="all-listed-food.php" style="color: white">Listed Food</a></h4>
...
?>
			<div class="col-md-4 market-update-gd" style="margin-top:1%;">
				<div class="market-update-block clr-block-1">
					...
					<div class="col-md-8 market-update-left">
					<a href="completed-requests.php"><h4>Fulfilled Requests</h4></a>
